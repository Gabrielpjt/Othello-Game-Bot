...
def simulated_annealing(game, max_time=4, move_probability=0.5):
    ...
    current_state_value = evaluate_game_state(first_game_eval)
    ...
    while T > 0:
        ...
        new_state_value = evaluate_game_state(new_game)
        ...
        if new_move not in selected_move:
            if new_state_value > current_state_value:
                ...
                print((new_state_value - current_state_value) / T)
                print(probability)
